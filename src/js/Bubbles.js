...
import ViteLogo from "../images/skill-logos/vite.svg";
import TailwindLogo from "../images/skill-logos/tailwind.svg";
import NextJSLogo from "../images/skill-logos/nextjs.svg";
...
const Bubbles = () => {
    ...
    return (
        <div className="bubbles-container">
            ...
            <Bubble isAnimating={isAnimating} name="Vite" src={ViteLogo} />
            <Bubble isAnimating={isAnimating} name="Tailwind" src={TailwindLogo} />
            <Bubble isAnimating={isAnimating} name="NextJS" src={NextJSLogo} />
